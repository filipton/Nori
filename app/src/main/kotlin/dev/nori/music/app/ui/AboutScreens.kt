...
private val CREDITS = listOf(
    ...
    "Android" to listOf(
        ...
        Credit("AndroidX Palette, Navigation, Lifecycle, Activity, Core", "Colours from covers, and the app's plumbing", "Copyright The Android Open Source Project", "Apache-2.0", "Apache-2.0"),
