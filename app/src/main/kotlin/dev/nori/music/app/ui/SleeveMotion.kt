...
internal fun MotionDirector(vm: PlayerViewModel, motion: SleeveMotion, sheet: PlayerSheet, onArtwork: Boolean) {
    ...
    // The music paused, the picture goes on moving (the owner's call, 2026-09-26): held, it stopped on
    // whatever frame it was in the middle of. It still stops with the screen, the app or the player put
    // away, and the screen's own timeout bounds a player left open over a paused song.
