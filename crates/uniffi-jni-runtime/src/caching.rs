...
//! Cache JNI classes and methods
//!
//! This avoids paying the lookup cost each time we want to call the method
//! or check an object's class.
//!
//! This module also contains a bunch of boilerplate for making calls to cached methods.
    ...
    pub unsafe fn get(&self, env: *mut JNIEnv) -> jclass {
        ...
        unsafe {
            *self.once_lock.get_or_init(|| {
                // NORI: through the app's class loader when called from a thread Rust started.
                let class = crate::find_class(env, self.class_name);
                if class.is_null() {
                    panic!("Class not found: {}", self.class_name.to_string_lossy());
                }
                ((**env).v1_4.NewGlobalRef)(env, class)
            })
        }
    }
}
...
impl CachedMethod {
    ...
    pub unsafe fn get(&self, env: *mut JNIEnv) -> jmethodID {
        ...
        unsafe {
            *self.once_lock.get_or_init(|| {
                ...
                let method_id = ((**env).v1_4.GetMethodID)(
                    env,
                    class,
                ...
                let class = ((**env).v1_4.NewGlobalRef)(env, class);
                if class.is_null() {
                    panic!(
    ...
    pub unsafe fn call_void<const N: usize>(
        ...
        ((**env).v1_4.CallVoidMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(())
        } else {
            Err(exc)
    ...
    pub unsafe fn call_object<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallObjectMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_boolean<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallBooleanMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_byte<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallByteMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    /// Call a method that returns a Short
    ///
    /// # Safety
    ///
    /// * env must point to a valid JNIEnv
    /// * The method must return a Short and the args must match the signature
    pub unsafe fn call_short<const N: usize>(
        &self,
        env: *mut JNIEnv,
        obj: jobject,
        args: [jvalue; N],
    ) -> Result<jshort, jthrowable> {
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallShortMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_int<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallIntMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_long<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallLongMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_float<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallFloatMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_double<const N: usize>(
        ...
        let method_id = self.get(env);
        let v = ((**env).v1_4.CallDoubleMethodA)(env, obj, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
...
impl CachedStaticMethod {
    ...
    pub unsafe fn get(&self, env: *mut JNIEnv) -> (jclass, jmethodID) {
        ...
        unsafe {
            *self.once_lock.get_or_init(|| {
                ...
                let method_id = ((**env).v1_4.GetStaticMethodID)(
                    env,
                    class,
                    self.method_name.as_ptr(),
                    self.sig.as_ptr(),
    ...
    pub unsafe fn call_void<const N: usize>(
        ...
        ((**env).v1_4.CallStaticVoidMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(())
        } else {
    ...
    pub unsafe fn call_object<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticObjectMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_boolean<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticBooleanMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_byte<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticByteMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_short<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticShortMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_int<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticIntMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_long<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticLongMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_float<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticFloatMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
    ...
    pub unsafe fn call_double<const N: usize>(
        ...
        let (class, method_id) = self.get(env);
        let v = ((**env).v1_4.CallStaticDoubleMethodA)(env, class, method_id, args.as_ptr());
        let exc = ((**env).v1_4.ExceptionOccurred)(env);
        if exc.is_null() {
            Ok(v)
        } else {
